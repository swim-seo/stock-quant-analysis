...
STOCKS: list[tuple[str, str, str]] = [
    ...
    ("267260.KS", "HD현대일렉트릭", "소재/산업재"), ("130660.KS", "한전산업", "소재/산업재"),
    ("298040.KS", "효성중공업", "소재/산업재"), ("001440.KS", "대한전선", "소재/산업재"),
    ("062040.KS", "산일전기", "소재/산업재"), ("003720.KS", "삼영", "소재/산업재"),
    ...
    ("023160.KS", "태광", "조선"), ("017960.KS", "한국카본", "조선"),
    ("082740.KS", "한화엔진", "조선"), ("077970.KS", "STX엔진", "조선"),
    # 방산
    ("012450.KS", "한화에어로스페이스", "방산"), ("079550.KS", "LIG넥스원", "방산"),
    ("064350.KS", "현대로템", "방산"), ("272210.KS", "한화시스템", "방산"),
    ("000880.KS", "한화", "방산"), ("010820.KS", "퍼스텍", "방산"),
    ("103140.KS", "풍산", "방산"),
    # 원자력
    ...
    ("098070.KQ", "한텍", "원자력"), ("096350.KQ", "대창솔루션", "원자력"),
    ("376180.KQ", "피코그램", "원자력"), ("006910.KQ", "보성파워텍", "원자력"),
    ("042370.KQ", "비츠로테크", "원자력"), ("189860.KQ", "서전기전", "원자력"),
    ("094820.KQ", "일진파워", "원자력"),
    # 건설
    ...
    ("462350.KQ", "이노스페이스", "우주항공"), ("082920.KQ", "비츠로넥스텍", "우주항공"),
    ("441270.KQ", "나라스페이스테크놀로지", "우주항공"), ("274090.KQ", "켄코아에어로스페이스", "우주항공"),
    ("272290.KQ", "이녹스첨단소재", "우주항공"),
    # 화장품
    ("257720.KQ", "실리콘투", "화장품"), ("278470.KQ", "에이피알", "화장품"),
    ("123690.KS", "한국화장품", "화장품"), ("192820.KS", "코스맥스", "화장품"),
    ("090430.KS", "아모레퍼시픽", "화장품"), ("027050.KS", "코리아나", "화장품"),
    ("161890.KS", "한국콜마", "화장품"), ("214420.KQ", "토니모리", "화장품"),
    # 로봇
    ("267250.KS", "HD현대", "로봇"), ("277810.KQ", "레인보우로보틱스", "로봇"),
    ("090360.KQ", "로보스타", "로봇"), ("454910.KQ", "두산로보틱스", "로봇"),
    ("056190.KQ", "에스에프에이", "로봇"), ("108490.KQ", "로보티즈", "로봇"),
    ("090710.KQ", "휴림로봇", "로봇"),
    # 광통신
    ("046970.KQ", "우리로", "광통신"), ("038680.KQ", "에스넷", "광통신"),
    ("010170.KQ", "대한광통신", "광통신"), ("043260.KQ", "성호전자", "광통신"),
    ("115440.KQ", "우리넷", "광통신"), ("037030.KQ", "파워넷", "광통신"),
    ("100130.KQ", "AP위성", "광통신"),
]
